...
const qqreadurlKey = 'qqreadurl1'+jbid
const qqreadurlVal = $.getdata(qqreadurlKey)


const qqreadheaderKey = 'qqreadhd1'+jbid
const qqreadheaderVal= $.getdata(qqreadheaderKey)

const qqreadbodyKey = 'qqreadbody1'+jbid
const qqreadbodyVal = $.getdata(qqreadbodyKey)




const qqreadtimeurlKey = 'qqreadtimeurl1'+jbid
const qqreadtimeurlVal = $.getdata(qqreadtimeurlKey)


const qqreadtimeheaderKey = 'qqreadtimehd1'+jbid
